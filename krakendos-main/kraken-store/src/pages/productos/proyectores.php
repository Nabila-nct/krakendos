...
<body>
    ...
    <div class="container">
        <h1 class="text-center my-4"><?php echo obtenerNombreCategoria(basename($_SERVER['PHP_SELF'])); ?>Proyectores</h1>
        
        <div class="row align-items-center mb-5">
            <div class="col-md-6 text-center">
                <img src="/kraken-store/assets/images/proyectores/mc300.jpg" class="magcubic-300" alt="Proyector Magcubic 300" width="400px" height=auto>
            </div>
            <div class="col-md-6">
                <h2>Proyector Magcubic 300</h2>
                <p>Proyector portátil con Sistema Android, playstore, Netflix, Smat TV. 250 Lumenes. Full HD 1080p. expandible hasta 120". Bluetooth. HDMI, USB Y Auxiliar</p>
                <h3>$1299</h3>
                <p>*Envio gratis</p>
            </div>
        </div>
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 order-md-2 text-center">
                <img src="/kraken-store/assets/images/proyectores/mc320.jpg" class="magcubic-300" alt="Proyector Magcubic 320" width="400px" height=auto>
            </div>
            <div class="col-md-6 order-md-1">
                <h2>Proyector Magcubic 320</h2>
                <p>Proyector portátil con Sistema Android, playstore, Netflix, Smat TV. 320 Lumenes. Full HD 2160p. expandible hasta 180". Bluetooth. HDMI, USB Y Auxiliar</p>
                <h3>$1599</h3>
                <p>*Envio gratis</p>
            </div>
        </div>
