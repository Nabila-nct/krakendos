    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 text-center">
                <img src="/assets/images/proyectores/mc300.jpg" class="magcubic-300" alt="Proyector Magcubic 300" width="400px" height=auto>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 order-md-2 text-center">
                <img src="/assets/images/proyectores/mc320.jpg" class="magcubic-300" alt="Proyector Magcubic 320" width="400px" height=auto>
            </div>
