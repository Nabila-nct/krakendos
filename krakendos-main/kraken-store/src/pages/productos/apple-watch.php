...
<body>
    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 text-center">
                <img src="/assets/images/apple-watch/hellomini.png" class="applewatch-mini" alt="Apple Watch Series 10 OEM" width="400px" height=auto>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 order-md-2 text-center">
                <img src="/assets/images/apple-watch/helloproplus.png" class="applewatch-proplus" alt="Apple Watch Series 10 OEM" width="400px" height=auto>
            </div>
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6 text-center">
            <img src="/assets/images/apple-watch/ultranegro.jpg" class="applewatch-ultra" alt="Apple Watch Ultra 2 OEM" width="400px" height=auto>
        </div>
        <div class="col-md-6">
            <h2>Apple Watch Series 10 OEM</h2>
                <p>Todas las funciones de notificaciones, llamadas y actividad física, con pantalla AMOLED, 4gb de memoria y galeria de fotos.</p>
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6 order-md-2 text-center">
            <img src="/assets/images/apple-watch/s9nike.png" class="applewatch-nike" alt="Apple Watch Serie 9 Nike Edition 1:1" width="400px" height=auto>
        </div>
        <div class="col-md-6 order-md-1">
...
<div class="row align-items-center mb-5">
    <div class="col-md-6 text-center">
        <img src="/assets/images/apple-watch/ultra1.png" class="applewatch-ultra1" alt="Apple Watch Ultra 1 1:1" width="400px" height=auto>
    </div>
    <div class="col-md-6">
...
<div class="row align-items-center mb-5">
    <div class="col-md-6 order-md-2 text-center">
        <img src="/assets/images/apple-watch/helloplus.png" class="applewatch-ultra2" alt="Apple Watch Ultra 1:1" width="400px" height=auto>
    </div>
    <div class="col-md-6 order-md-1">
