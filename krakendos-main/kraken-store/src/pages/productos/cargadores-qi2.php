...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 text-center">
                <img src="/kraken-store/assets/images/misc/q12rotativo.jpg" class="audifonos-uno" alt="AirPods Primera Generación">
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 order-md-2 text-center">
                <img src="/kraken-store/assets/images/misc/viaje.png" class="audifonos-uno-dos" alt="AirPods Segunda Generación">
            </div>
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6 text-center">
            <img id="airpods3gen" src="/kraken-store/assets/images/misc/compacto.png" class="audifonos-uno" alt="AirPods Tercera Generación">
        </div>
        <div class="col-md-6">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6 order-md-2 text-center">
            <img src="/kraken-store/assets/images/cargadores/cargadorescritorio.jpg" class="audifonos-uno-dos" alt="AirPods Segunda Generación">
        </div>
        <div class="col-md-6 order-md-1">
