    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 text-center">
                <img src="/assets/images/cargadores/20wc.jpeg" class="audifonos-uno" alt="Cubo de 20W C">
            </div>
            <div class="col-md-6">
                <h2>Cubo de 20W C</h2>
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 order-md-2 text-center">
                <img src="/assets/images/cargadores/usb5w.jpg" class="audifonos-uno" alt="Cubo de 5W USB">
            </div>
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 text-center">
                <img src="/assets/images/cargadores/c-lightning.jpeg" class="audifonos-uno" alt="Cable C a Lightning">
            </div>
            <div class="col-md-6">
